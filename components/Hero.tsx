...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* <img
        className="mr-2 transition-transform duration-500 transform rounded-full hover:rotate-360 hover:scale-75"
        src="/static/logos/logo.jpg"
        width="60"
      /> */}
      <p className="mb-5 text-xl">Hey, I'm Bianca.</p>
      <h1 className="relative inline-block w-auto max-w-2xl mb-10 text-5xl font-bold tracking-tighter heroTitle lg:max-w-4xl md:text-6xl lg:text-7xl ">
        ...
        />
        <img
          className="sqD hidden sm:block bottom-[-340px] left-[-150px]"
      ...
      <Link href="/#learnmore" legacyBehavior>
        <a onClick={scrollHandle}>
          <div className="px-10 py-4 text-xl font-bold transition-colors border-2 rounded-full cursor-pointer whitespace-nowrap text-fun-white border-fun-white bg-gradient-to-r from-black to-gray-800 hover:bg-fun-pink hover:text-white hover:border-fun-pink">
            Tell me more
          </div>
        </a>
      </Link>
      {/* <img
        // className="sqD min-w-[800px] bottom-[-100px] sm:bottom-[-150px] -translate-x-1/2 object-cover sm:min-w-[1100px]"
        style={{ zIndex: "-10" }}
