    ...
    <div className="relative w-full pt-36">
      ...
      <div className="pb-40 pt-14">
        ...
        <a
          ...
          className="px-8 py-3 mt-6 font-bold text-white transition-colors border-2 border-white rounded-full cursor-pointer whitespace-nowrap bg-gradient-to-r from-black to-gray-800 hover:bg-fun-pink hover:border-fun-pink"
        >
          Get in Touch
        </a>
      </div>
